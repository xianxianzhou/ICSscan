...
@Slf4j
@Component
public class UptickTask extends DataAbstract {
    ...
    public void getBlockInfo() {
        ...
        try {
            ChainInfo chainInfo = chainInfoService.getByChainid(nodeConfiguration.getUptickChainid());
            if (chainInfo == null) {
                return;
            }
            Long height = chainInfo.getHeight();
            String url = nodeConfiguration.getUptickApi() + String.format(getBlockByHeight, height);
           log.info("chain id: {} get block height: {}",getChainId(),height);
            ...
            if (resultStr != null) {
                ...
                if (blockResult != null && blockResult.getCode() == 0) {
                            ...
                            public void run() {
                                ...
                                for (String tx : list) {
                                    try {
                                        ...
                                        String transactionUrl = nodeConfiguration.getUptickApi() + String.format(txs, hash);
                    ...
                    height++;
                    chainInfoService.updateHeight(nodeConfiguration.getUptickChainid(), height);
    ...
    public String getChainId() {
        return nodeConfiguration.getUptickChainid();
    }
}
